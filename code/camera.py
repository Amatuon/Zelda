...
class Tree(pygame.sprite.Sprite):
	def __init__(self,pos,group):
		...
		self.image = pygame.image.load('graphics/camera_test/tree.png').convert_alpha()
		self.rect = self.image.get_rect(topleft = pos)

class Player(pygame.sprite.Sprite):
	def __init__(self,pos,group):
		super().__init__(group)
		self.image = pygame.image.load('graphics/camera_test/player.png').convert_alpha()
...
class CameraGroup(pygame.sprite.Group):
	def __init__(self):
		...
		# ground
		self.ground_surf = pygame.image.load('graphics/camera_test/ground.png').convert_alpha()
	...
	def zoom_keyboard_control(self):
		...
		if keys[pygame.K_q]:
			self.zoom_scale += 0.1
		if keys[pygame.K_e] and self.zoom_scale > 0.1:
			self.zoom_scale -= 0.1
